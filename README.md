# TextToHandwritingWebsite
A Website to write text to handwritting 

### Installation options

**Option one:** One-click deploy

[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/Achu2234/TextToHandwritingWebsite)
